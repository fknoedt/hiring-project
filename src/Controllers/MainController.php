...
abstract class MainController
{
    ...
    /**
     * Add received data to the default data array
     * This can be used to pass default data to templates
     * @param $data
     * @return array
     */
    public function tplData($data = []): array
    {
        $defaultData = [
